...
namespace ExchangeSharp
{
    public sealed partial class ExchangeBitBankAPI : ExchangeAPI
    {
        ...
        protected override async Task<ExchangeOrderResult> OnPlaceOrderAsync(ExchangeOrderRequest order)
        {
            ...
            JToken token = await MakeJsonRequestAsync<JToken>("/TestModel/spot/order", baseUrl: BaseUrlPrivate, payload: payload, requestMethod: "POST");
        ...
        protected override async Task OnCancelOrderAsync(string orderId, string marketSymbol = null)
        {
            ...
            await MakeJsonRequestAsync<JToken>("/TestModel/spot/cancel_order", baseUrl: BaseUrlPrivate, payload: payload, requestMethod: "POST");
        }
        protected override async Task<ExchangeOrderResult> OnGetOrderDetailsAsync(string orderId, string marketSymbol = null)
        {
            ...
            JToken token = await MakeJsonRequestAsync<JToken>("/TestModel/spot/order", baseUrl: BaseUrlPrivate, payload: payload);
            return ParseOrder(token);
        }
        protected override async Task<IEnumerable<ExchangeOrderResult>> OnGetOpenOrderDetailsAsync(string marketSymbol = null)
        {
            ...
            if (marketSymbol != null)
                payload.Add("pair", NormalizeMarketSymbol(marketSymbol));
            JToken token = await MakeJsonRequestAsync<JToken>("/TestModel/spot/active_orders", baseUrl: BaseUrlPrivate, payload: payload);
        ...
        protected override async Task<IEnumerable<ExchangeOrderResult>> OnGetCompletedOrderDetailsAsync(string marketSymbol = null, DateTime? afterDate = null)
        {
            ...
            JToken token = await MakeJsonRequestAsync<JToken>($"/TestModel/spot/trade_history", baseUrl: BaseUrlPrivate, payload: payload);
        ...
        protected override async Task<ExchangeWithdrawalResponse> OnWithdrawAsync(ExchangeWithdrawalRequest withdrawalRequest)
        {
            ...
            JToken token1 = await MakeJsonRequestAsync<JToken>($"/TestModel/withdrawal_account", baseUrl: BaseUrlPrivate, payload: payload1);
            ...
            JToken token2 = await MakeJsonRequestAsync<JToken>($"/TestModel/request_withdrawal", baseUrl: BaseUrlPrivate, payload: payload2, requestMethod: "POST");
        ...
        */
        ...
        {
            JToken token = await MakeJsonRequestAsync<JToken>($"/TestModel/assets", baseUrl: BaseUrlPrivate, payload: await GetNoncePayloadAsync(), requestMethod: "GET");
